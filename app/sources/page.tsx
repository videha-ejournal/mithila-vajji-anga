...
export const metadata = {
  ...
  alternates: { canonical: 'https://videha-ejournal.github.io/mithila-vajji-anga/sources/' },
};
  ...
  return (
    <main className="reference-page" id="top">
      <header className="reference-hero">
        ...
        <div className="reference-meta"><strong>{learningData.chronology.length} cited entries</strong><span>Source corpus retained; scholarly infrastructure updated 13 September 2026</span></div>
      </header>
      <nav className="reference-actions" aria-label="Source register controls">
        <a href="../index.html#wing-2">Historical map</a><a href="../index.html#explorer">Browse histories</a><a href="../records/">Permanent records</a><a href="../method/">Editorial method</a><a href="https://www.videha.co.in/" target="_blank" rel="noreferrer">Videha <ExternalLink /></a>
      </nav>
