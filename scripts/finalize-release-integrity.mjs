...
const report = {
  ...
  title: TITLE,
  bilingualArchitecture: 'paired Maithili and English interfaces from a shared feature source, with curated Maithili UI generation and explicit source-language preservation',
  rootLanguage: 'mai',
  englishLanguage: 'en',
  routePairs: 187,
  pairedSitemapRoutes: 374,
  historyChapterPairs: 178,
  historyChapters: 178,
  sourceLanguagePolicy: 'reviewed-or-source-language; machine translation is not published as reviewed scholarship',
